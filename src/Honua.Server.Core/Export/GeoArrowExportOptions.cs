...
/// <summary>
/// Configuration controlling GeoArrow export behaviour.
/// </summary>
public sealed record GeoArrowExportOptions
{
    /// <summary>
    /// Default options used when no configuration is supplied.
    /// </summary>
    public static GeoArrowExportOptions Default { get; } = new();
    ...
    public GeoArrowExportOptions Validate()
    {
        if (MaxFeatures <= 0)
        {
