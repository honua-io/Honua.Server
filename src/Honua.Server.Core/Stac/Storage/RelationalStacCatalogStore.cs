...
from stac_collections";
    ...
    private static async Task<int> ExecuteNonQueryAsync(DbConnection connection, DbTransaction transaction, string sql, IReadOnlyList<(string Name, object? Value)> parameters, CancellationToken cancellationToken)
    {
        await using var command = connection.CreateCommand();
    ...
    private static IReadOnlyList<(string Name, object? Value)> BuildCollectionParameters(StacCollectionRecord collection, string? newETag = null, string? expectedETag = null)
    {
    ...
    private static IReadOnlyList<(string Name, object? Value)> BuildItemParameters(StacItemRecord item, string? newETag = null, string? expectedETag = null)
    {
    ...
    private static StacCollectionRecord ReadCollection(DbDataReader reader)
    {
    ...
    private static StacItemRecord ReadItem(DbDataReader reader)
    {
