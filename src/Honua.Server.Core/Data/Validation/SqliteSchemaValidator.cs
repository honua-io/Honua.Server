...
/// Uses SqliteSchemaDiscoveryService to discover schema and validate against metadata.
/// </summary>
public sealed class SqliteSchemaValidator : ISchemaValidator
{
    private readonly SqliteSchemaDiscoveryService _discoveryService;
    private readonly ILogger<SqliteSchemaValidator> _logger;

    public SqliteSchemaValidator(
        SqliteSchemaDiscoveryService discoveryService,
        ILogger<SqliteSchemaValidator> logger)
    {
