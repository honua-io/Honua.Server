...
/// <summary>
/// SQL Server schema validator.
/// Uses SqlServerSchemaDiscoveryService to discover schema and validate against metadata.
/// </summary>
public sealed class SqlServerSchemaValidator : ISchemaValidator
{
    ...
    private readonly ILogger<SqlServerSchemaValidator> _logger;

    public SqlServerSchemaValidator(
        SqlServerSchemaDiscoveryService discoveryService,
        ILogger<SqlServerSchemaValidator> logger)
    {
