...
/// <summary>
/// CLI command to pause a running Semantic Kernel process.
/// </summary>
[Description("Pause a running process")]
public sealed class ProcessPauseCommand : AsyncCommand<ProcessPauseCommand.Settings>
{
    private readonly IAnsiConsole _console;

    public ProcessPauseCommand(IAnsiConsole console)
    {
    ...
    public sealed class Settings : CommandSettings
    {
        ...
        [Description("Process ID to pause")]
