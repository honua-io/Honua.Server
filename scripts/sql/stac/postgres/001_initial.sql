...
CREATE INDEX IF NOT EXISTS idx_stac_items_geometry ON stac_items USING GIST (ST_GeomFromGeoJSON(geometry_json));
CREATE INDEX IF NOT EXISTS idx_stac_items_raster ON stac_items(collection_id, raster_dataset_id);
